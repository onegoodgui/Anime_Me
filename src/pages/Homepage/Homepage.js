    ...
    async function getAnimeList() {
      try {
        ...
        const a = animeList.map((anime) => {
          ...
          return columns[anime.status].items.push({
            id: dbId.toString(),
            ...animeData,
            genres,
            image,
    ...
    <HomepageStyle>
      <main>
        <MainFeature height={500}>
          ...
          <AnimePoster
            src={randomAnime.length === 0 ? "" : randomAnime.coverImage.large}
          />
        ...
        <AnimeTitle color={openDoor ? "#000" : "transparent"}>
